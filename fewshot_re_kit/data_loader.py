...
class FewRelDataset(data.Dataset):
    ...
    FewRel Dataset
    """
    def __init__(self, name, encoder, N, K, Q, na_rate, root, ispubmed=False):
        self.root = root
...
def get_loader(name, encoder, N, K, Q, batch_size, 
        num_workers=0, collate_fn=collate_fn,ispubmed=False, na_rate=0, root='./data'):
    dataset = FewRelDataset(name, encoder, N, K, Q, na_rate, root, ispubmed)
...
def get_loader2(name, encoder, N, K, Q, batch_size, 
        num_workers=8, collate_fn=collate_fn22,ispubmed=False, na_rate=0, root='./data'):
    dataset = FewRelTestDataset(name, encoder, N, K, Q, na_rate, root, ispubmed)
